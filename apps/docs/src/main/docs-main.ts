...
const tMain = createI18n({
  zh: {
    ...
    errNoDeepSeekKey:
      '未配置 DeepSeek API Key:请设置 DEEPSEEK_API_KEY 环境变量,或在 ai-settings.json 中填写后重试',
    ...
    menuWindow: '窗口',
    menuHelp: '帮助',
    menuDocsHelp: 'DeepOffice Docs 帮助',
  },
  en: {
    ...
    errNoDeepSeekKey:
      'No DeepSeek API key configured - set the DEEPSEEK_API_KEY environment variable or add a key in ai-settings.json, then retry',
    ...
    menuWindow: 'Window',
    menuHelp: 'Help',
    menuDocsHelp: 'DeepOffice Docs Help',
  },
  ja: {
    dlgOpenDoc: '文書を開く',
    filterWord: 'Word 文書',
    ...
    menuWindow: 'ウィンドウ',
    menuHelp: 'ヘルプ',
    menuDocsHelp: 'DeepOffice Docs ヘルプ',
  },
  ko: {
    dlgOpenDoc: '문서 열기',
    filterWord: 'Word 문서',
    ...
    menuWindow: '창',
    menuHelp: '도움말',
    menuDocsHelp: 'DeepOffice Docs 도움말',
  },
  fr: {
    ...
    menuWindow: 'Fenêtre',
    menuHelp: 'Aide',
    menuDocsHelp: 'Aide DeepOffice Docs',
  },
  de: {
    ...
    menuWindow: 'Fenster',
    menuHelp: 'Hilfe',
    menuDocsHelp: 'DeepOffice Docs-Hilfe',
  },
  es: {
    ...
    menuWindow: 'Ventana',
    menuHelp: 'Ayuda',
    menuDocsHelp: 'Ayuda de DeepOffice Docs',
  },
  th: {
    ...
    menuWindow: 'หน้าต่าง',
    menuHelp: 'วิธีใช้',
    menuDocsHelp: 'วิธีใช้ DeepOffice Docs',
  },
  id: {
    ...
    menuWindow: 'Jendela',
    menuHelp: 'Bantuan',
    menuDocsHelp: 'Bantuan DeepOffice Docs',
  },
  ru: {
    ...
    menuWindow: 'Окно',
    menuHelp: 'Справка',
    menuDocsHelp: 'Справка DeepOffice Docs',
  },
  ar: {
    ...
    menuWindow: 'نافذة',
    menuHelp: 'تعليمات',
    menuDocsHelp: 'تعليمات DeepOffice Docs',
  },
  pt: {
    dlgOpenDoc: 'Abrir Documento',
    ...
    menuWindow: 'Janela',
    menuHelp: 'Ajuda',
    menuDocsHelp: 'Ajuda do DeepOffice Docs',
  },
  it: {
    ...
    menuWindow: 'Finestra',
    menuHelp: 'Aiuto',
    menuDocsHelp: 'Guida di DeepOffice Docs',
  },
  pl: {
    ...
    menuWindow: 'Okno',
    menuHelp: 'Pomoc',
    menuDocsHelp: 'Pomoc DeepOffice Docs',
  },
  nl: {
  ...
  he: {
    ...
    menuWindow: 'חלון',
    menuHelp: 'עזרה',
    menuDocsHelp: 'עזרה של DeepOffice Docs',
  },
  hi: {
    ...
    menuWindow: 'विंडो',
    menuHelp: 'सहायता',
    menuDocsHelp: 'DeepOffice Docs सहायता',
  },
  'zh-TW': {
    dlgOpenDoc: '開啟文件',
    filterWord: 'Word 文件',
    ...
    menuWindow: '視窗',
    menuHelp: '說明',
    menuDocsHelp: 'DeepOffice Docs 說明',
  },
})
...
/** default folder where new files land on their first (silent) save; shared with the other editors via shell. User-configurable (app-settings.json), falls back to <Documents>/DeepOffice. */
...
export function startDocsStandalone(): void {
  ...
  // the installed DeepOffice Docs is open and forwards its argv there instead.
  if (isDev) app.setPath('userData', join(app.getPath('appData'), 'DeepOffice Docs Dev'))
